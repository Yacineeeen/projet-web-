...
// Récupérez toutes les enchères depuis la base de données
...
<body>
                    ...
                    <div class="row">
                        <div class="col-xl-6 col-md-12 col-lg-8">
                            <div class="short_contact_list">
                                <ul>
                                    <li><a href="#"> <i class="fa fa-phone"></i> +216 58873878</a></li>
                                    ...
                                    <ul id="navigation">
                                        ...
                                        <li><a href="#">Blog <i class="ti-angle-down"></i></a>
                                            <ul class="submenu">
                                                ...
                                                <li><a href="single-blog.html">Article unique</a></li>
                                            </ul>
                                        </li>
    ...
    <div class="popular_causes_area section_padding">
                ...
                ?>
                    ...
                    <div class="col-lg-4">
                        <div class="single_cause">
                            <div class="thumb">
                                <img src="../view/image_bd/<?= htmlspecialchars($enchere['image_objet']) ?>" alt="<?= htmlspecialchars($enchere['nom_objet']) ?>">
        ...
        <button id="creer" class="mx-auto" onclick="window.location.href='../view/ajout_enchere.php'" type="button">Créer l'enchère</button>
    </div>
