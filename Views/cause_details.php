...
if (isset($_GET['id_donation'])) {
    ...
    $dons = $donsC->show_Dons($id_donation);
} else {
...
<body>
    ...
    <!-- header-start -->
    <header>
        <input type="hidden" name="id_donation" value="valeur_de_l_id">
                        ...
                        <div class="col-xl-6 col-md-12 col-lg-8">
                            <div class="short_contact_list">
                                <ul>
                                    ...
                                    <li><a href="#"> <i class="fa fa-envelope"></i>SADAKA@gmail.com</a></li>
                                </ul>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="bradcam_text text-center">
                        <h3>Mises aux dons solidaires</h3>
    ...
    <form action="../Views/ajout_participation.php" class="bid_form text-center" method="POST">
        <input type="hidden" name="id_donation" value="<?= $dons['id_donation'] ?>">
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="single_cause">
                            ...
                            <div class="causes_content">
                                ...
                                <p>
                                    <?= htmlspecialchars($dons['descr']) ?>
                                </p>
                                <div class="balance d-flex justify-content-between align-items-center" name="amount">
                                    <span>Prix Actuel:
                                        <?= htmlspecialchars($dons['amount']) ?>$
                                    </span>
                                </div>
                            </div>
                        </div>
