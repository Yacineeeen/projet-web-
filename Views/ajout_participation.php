...
$tab = $c->show_Dons($_POST["id_donation"]);
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (
        ...
        if (!empty($nom) && !empty($prenom) && !empty($montant)  && !empty($email) && !empty($tel)) {
...
<head>
    ...
    <link rel="stylesheet" rel="stylesheet" href="../Views/css2/main.css">
...
<div class="page-wrapper bg-gra-03 p-t-45 p-b-50">
    <div class="wrapper wrapper--w790">
        <div class="card card-5">
            ...
            <div class="card-body">
                <form method="POST" action="ajout_participation.php" enctype="multipart/form-data" >
