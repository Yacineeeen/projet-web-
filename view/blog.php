...
$sql = "SELECT id, img ,titre, contenu, auteur, date_pub FROM publication";
...
if ($result->num_rows > 0) {
    ...
    // Fetch each row and add it to the $articles array
                    ...
                    foreach ($publication as $publication) {
                        ...
                        <article class="blog_item">
                            ...
                            <div class="blog_details">
                                ...
                                <?php
                                // You can now use $publicationData to display additional details about the publication
                                // For example: echo $publicationData['additional_field'];
                                ?>
                            </div>
                        </article>
                    <?php } ?>
