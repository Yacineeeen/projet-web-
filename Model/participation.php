...
class participation
{
    ...
    public function __construct($id_participation, $nom, $prenom, $montant, $date_p, $email, $tel, $id_donation)
    {
    ...
    public function setdons($id_donation)
    {
        $this->id_donation = $id_donation;
    }
}
