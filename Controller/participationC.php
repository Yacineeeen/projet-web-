    ...
    public function listparticipationbyid($id)
{
    ...
    public function delete_participation($id_participation)
    {
    ...
    public function ajout_participation(participation $participation)
    {
        $sql = "INSERT INTO participation (nom, prenom, montant, date_p, email, tel, id_donation) VALUES (:nom, :prenom, :montant, :date_p, :email, :tel, :id_donation)";
    ...
    public function show_participation($id_participation)
    {
